...
export const Timeline = ({
  ...
  return (
    (<div
      id="experiencia"
      className="w-full max-w-4xl h-full max-h-[1200px] md:max-h-[1600px]"
      ref={containerRef}>
      <div ref={ref} className="relative pb-20">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-6">
            <div
